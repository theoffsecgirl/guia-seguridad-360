...
## Casos de Bug Bounty y Recompensas

### Severidad Típica
- **Critical (P1):** $5,000 - $20,000+ 
  - Exposición de PII, tokens de autenticación, datos financieros
- **High (P2):** $1,000 - $5,000
  - Exposición de información sensible no crítica, CSRF tokens
- **Medium (P3):** $500 - $1,000  
  - Exposición de información de sesión, preferencias privadas

### Programas Activos que Aceptan WCD
- **HackerOne:** PayPal, Shopify, GitLab, Twitter, Uber
- **Bugcrowd:** Tesla, Fitbit, Western Union  
- **Programas privados:** Muchos bancos y fintech

### Tips para Maximizar Recompensas
1. **Demostrar impacto real** con PII específico expuesto
2. **Automatizar la detección** para encontrar múltiples endpoints
3. **Combinar con otras vulnerabilidades** (XSS, CSRF, SSRF)
4. **Documentar la persistencia** del cache
5. **Probar en múltiples subdominios** y entornos
